...
public class YoloObject extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yolo_object);
            ...
            if (ArrayLength >= 1) {
                ...
                for (int i = 0; i < ind.length; ++i) {
                    ...
                    if (intConf > 30) {
                        ...
                        //last = list.get(list.size() - 1);last.equals(cocoNames.get(idGuy));
